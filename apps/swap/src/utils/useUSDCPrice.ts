import { ChainId, Currency, currencyEquals, JSBI, Price, WETH } from "@repo/sugar-finance-sdk";
...
export default function useUSDCPrice(currency?: Currency): Price | undefined {
  ...
  const [[ethPairState, ethPair], [usdcPairState, usdcPair], [usdcEthPairState, usdcEthPair]] =
    usePairs(tokenPairs);
